...
class ProductRepository {
    ...
    async filter(minPrice, maxPrice,category) {
        try {
            ...
            const filteredProducts = await ProductModel.find(filterExpression).toArray();;
    ...
    async rateProduct(userID,productID,rating){
        ...
        const product = ProductModel.findOne({ _id : 
        ...
        // Create new entry
        await ProductModel.updateOne({ _id : new ObjectId(productID) }, {$push: 
